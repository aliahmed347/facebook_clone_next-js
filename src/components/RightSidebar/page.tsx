...
import RightSidebarSkelton from "../Skeltons/RightSidebar";
    ...
    <>
      ...
      <div className="w-full my-2 h-[calc(100vh-136px)] xl:h-[calc(100vh-88px)] overflow-y-auto no-scrollbar text-primaryText ">
        {loading ? (
          ...
          <>
            <div className="">
              <h2 className="text-base text-secondaryText">
                Group conversations
              </h2>
              <div
            ...
            <div className="">
              <h2 className="text-base text-secondaryText whitespace-nowrap">
                Suggested people
              </h2>
              ...
              <ul className="mt-3 mr-8">
                {users?.map((user, index) => (
                  <Link
                    href={`/user/${user._id}`}
                    key={index}
                    className=" flex items-center gap-4 py-1 px-2 hover:bg-[#E4E6E9] cursor-pointer rounded-lg mt-1"
                  >
                    <div className="">
                      <Image
                        src={user.avatar}
